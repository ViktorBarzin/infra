	...
	return []capability{
		{
			...
			Detail: []string{
				...
				"        them and there is NO iOS instrument. Playwright WebKit launches on",
				"        the devvm and does not count: measured 2026-09-01 against the 15",
				"        iOS defects in the session corpus, it reproduces 2, both of which",
				"        headless Chromium already reproduces. Safe-area insets read 0px,",
				"        maxTouchPoints is 0, standalone/display-mode cannot be faked, and",
				"        share/push are undefined. Say which platform you are reproducing ON;",
				"        if the report does not say, ask in one line, and say plainly when the",
				"        answer is iOS and we cannot.",
			},
		},
		{
