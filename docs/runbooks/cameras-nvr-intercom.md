...
403 на чужд адрес и с 200 на `192.168.1.2`. Фабричната `admin` там още се приема,
но вече няма откъде да бъде подадена освен през rpi-sofia. `.202` е с по-нов фирмуер
