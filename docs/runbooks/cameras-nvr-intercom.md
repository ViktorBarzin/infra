...
Настройките за запис на канал 25 съвпадат с тези на работещия канал 26 (записът
е по събитие; единствената разлика е `PostRecordTimeSeconds` 60 срещу 30), а
детекцията на движение на самия панел е включена и с еднаква чувствителност.
