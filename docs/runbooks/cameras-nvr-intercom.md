...
| 08.09 | картичката е премахната при разчистване на repairs → **нищо не сочи, че канал 2 е офлайн** |

Каналът е офлайн поне от 09.08 (по-старото е извън обхвата на recorder-а).
Наблюдението по броя online канали от `/ISAPI/ContentMgmt/InputProxy/channels/status`
остава ненаправено и сега е единственото, което би хванало следващия такъв случай.
